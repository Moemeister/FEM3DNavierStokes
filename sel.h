...
void calculateLocalA(int i,Matrix &A,mesh m){
    ...
    A.at(0).at(0) = RestaTenedor(calcularTenedor(e,YE,3,1,m),calcularTenedor(e,ZETA,4,1,m),calcularTenedor(e,YE,4,1,m),calcularTenedor(e,ZETA,3,1,m));
    A.at(0).at(1) = RestaTenedor(calcularTenedor(e,YE,4,1,m),calcularTenedor(e,ZETA,2,1,m),calcularTenedor(e,YE,2,1,m),calcularTenedor(e,ZETA,4,1,m));
    A.at(0).at(2) = RestaTenedor(calcularTenedor(e,YE,2,1,m),calcularTenedor(e,ZETA,3,1,m),calcularTenedor(e,YE,3,1,m),calcularTenedor(e,ZETA,2,1,m));

    A.at(1).at(0) = RestaTenedor(calcularTenedor(e,EQUIS,4,1,m),calcularTenedor(e,ZETA,3,1,m),calcularTenedor(e,EQUIS,3,1,m),calcularTenedor(e,ZETA,4,1,m));
    A.at(1).at(1) = RestaTenedor(calcularTenedor(e,EQUIS,2,1,m),calcularTenedor(e,ZETA,4,1,m),calcularTenedor(e,EQUIS,4,1,m),calcularTenedor(e,ZETA,2,1,m));
    A.at(1).at(2) = RestaTenedor(calcularTenedor(e,EQUIS,3,1,m),calcularTenedor(e,ZETA,2,1,m),calcularTenedor(e,EQUIS,2,1,m),calcularTenedor(e,ZETA,3,1,m));

    A.at(2).at(0) = RestaTenedor(calcularTenedor(e,EQUIS,3,1,m),calcularTenedor(e,YE,4,1,m),calcularTenedor(e,EQUIS,4,1,m),calcularTenedor(e,YE,3,1,m));
    A.at(2).at(1) = RestaTenedor(calcularTenedor(e,EQUIS,4,1,m),calcularTenedor(e,YE,2,1,m),calcularTenedor(e,EQUIS,2,1,m),calcularTenedor(e,YE,4,1,m));
    A.at(2).at(2) = RestaTenedor(calcularTenedor(e,EQUIS,2,1,m),calcularTenedor(e,YE,3,1,m),calcularTenedor(e,EQUIS,3,1,m),calcularTenedor(e,YE,2,1,m));
...
float calculateLocalJ(int i,mesh m){
	...
	row1.push_back(calcularTenedor(e,EQUIS,2,1,m)); row1.push_back(calcularTenedor(e,EQUIS,3,1,m)); row1.push_back(calcularTenedor(e,EQUIS,4,1,m));

    row2.push_back(calcularTenedor(e,YE,2,1,m)); row2.push_back(calcularTenedor(e,YE,3,1,m)); row2.push_back(calcularTenedor(e,YE,4,1,m));

    row3.push_back(calcularTenedor(e,ZETA,2,1,m)); row3.push_back(calcularTenedor(e,ZETA,3,1,m)); row3.push_back(calcularTenedor(e,ZETA,4,1,m));
